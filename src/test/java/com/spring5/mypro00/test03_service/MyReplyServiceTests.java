...
//                myReplyService.getReplyList(new MyReplyPagingDTO(229376, 1));
...
//    	MyReplyVO myReply = new MyReplyVO(0L, 229376L, "서비스:게시물에 대한 댓글 등록 테스트", "test", null, null, 0, 0 );
////        MyReplyVO myReply = new MyReplyVO();
////        myReply.setBno(229404);
...
//    	MyReplyVO myReply = new MyReplyVO(0L, 229376L, "서비스: 댓글에 대한 답글 등록 테스트", "test", null, null, 41L, 0 );
////    	MyReplyVO myReply = new MyReplyVO();
////        myReply.setBno(229404);
////        myReply.setRcontent("서비스 테스트 - 게시물의 댓글에 대한 답글 등록 테스트");
////        myReply.setRwriter("test");
////        myReply.setPrno(41L);  //앞에서 등록한 댓글번호
//
